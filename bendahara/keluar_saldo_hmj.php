      ...
      <form role="form" action="mumet.php" method="post">
        <div class="form-group">
          <label>Jumlah Pengeluaran</label>
            <input class="form-control" placeholder="Jumlah Dana" name="uang_keluar" required>
        </div>
        <div class="form-group">
            <label>Keperluan</label>
            <input class="form-control" placeholder="Keterangan Pengeluaran" name="guna" required>
        </div>
        <div class="form-group">
