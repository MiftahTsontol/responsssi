...
<div class="panel panel-primary text-center no-boder bg-color-white">
    <div class="panel-footer active-menu">
      <h3>
        Saldo Pengurus Harian Himpunan Mahasiswa Jurusan 
      </h3>
    </div>
    <div class="panel-body">
        <i class="fa fa-money fa-3x"></i>
        <h1>Saldo Total Pengurus Harian Rp. <?php echo $totSaldoPh; ?>,- </h1>
    </div>
    <!-- saldo keseluruhan ph -->
    <?php
      if ($saldopakai[1]>0) {
        ?>
        <h1>Saldo yang dapat digunakan Rp. <?php echo $saldopakai[1]; ?>,- </h1>
